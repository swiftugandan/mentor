...
export const studentRegistrationSchema = registerSchema.merge(studentProfileSchema)
export const alumniRegistrationSchema = registerSchema.merge(alumniProfileSchema) 