...
export default function DashboardPage() {
  ...
  const acceptedRequests = mentorshipRequests.filter((request) => request.status === "ACCEPTED")
  
  const recentActivity: Activity[] = [
    ...upcomingSessions.map((session): SessionActivity => ({
      id: session.id,
      type: "session",
      title: session.title,
    ...
    ...mentorshipRequests.map((request): RequestActivity => ({
      id: request.id,
      type: "request",
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          <Card>
            ...
            <CardContent>
              ...
              <Button variant="link" className="mt-4 h-auto p-0" asChild>
                <Link href={isStudent ? "/dashboard/student/mentors" : "/dashboard/alumni/requests"}>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <Button variant="link" className="mt-4 h-auto p-0" asChild>
                <Link href={isStudent ? "/dashboard/student/sessions" : "/dashboard/alumni/sessions"}>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <Button variant="link" className="mt-4 h-auto p-0" asChild>
                <Link href={isStudent ? "/dashboard/student/requests" : "/dashboard/alumni/sessions"}>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <Button variant="link" className="mt-4 h-auto p-0" asChild>
                <Link href={isStudent ? "/dashboard/student/requests" : "/dashboard/alumni/availability"}>
                  {isStudent ? "Check status" : "Manage hours"} <ArrowRight className="ml-1 h-4 w-4" />
                </Link>
              </Button>
            </CardContent>
          </Card>
        ...
        <div className="grid gap-4 md:grid-cols-7">
          <Card className="col-span-4">
            <CardHeader>
              ...
              <CardDescription>Your latest mentorship interactions and updates</CardDescription>
            </CardHeader>
            <CardContent>
                      ...
                      {activity.type === "session" ? (
                        <>
                          ...
                          <div className="flex-1 space-y-1">
                            ...
                            <p className="text-sm text-muted-foreground">
                              Session with{" "}
                              {isStudent ? activity.mentor?.name : activity.student?.name}
                            </p>
                          </div>
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                <div className="space-y-1">
                  <CardTitle>{isStudent ? "Your Interests" : "Your Expertise"}</CardTitle>
                  <CardDescription>
                    {isStudent
